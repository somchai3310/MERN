      ...
      <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
        ...
        >
                  ...
                  return (
                    <div className="relative group">
                      <img
                        ...
                        height={80}
                        alt={el}
                        className="bg-slate-100 boreder cursor-pointer"
                        onClick={() => {
          ...
          <textarea
            ...
            className="h-28 bg-slate-100 border rounded-md resize-none p-1"
            onChange={handleOnChange}
          ></textarea>

          <button className="px-3 py-1 bg-red-600 text-white rounded-full mb-5 hover:bg-red-700">
            Upload Product
          </button>
        </form>
      </div>
